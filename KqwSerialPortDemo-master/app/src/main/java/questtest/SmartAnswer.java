...
public class SmartAnswer {
     ...
     */
    public void answer(String filePath, String ttsFilePath, Context context, String logPath, final RecorderResult recorderResult, PlayerResult playerResult) {
        voice = new VoiceFunc();
        voice.initSystem(context,logPath,filePath);
        voice.initRecorder(context, recorderResult);
        voice.initPlayer(context,ttsFilePath, playerResult);
        voice.recordStart();
