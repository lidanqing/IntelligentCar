...
public class VoiceFunc {
    ...
    public RecorderResult recorderResult = null;
     ...
     * @return boolean 成功标志位
     */
    public boolean initPlayer(Context context, String filePath, PlayerResult result) {
        playerResult = result;
     ...
     *
     */
    public void initRecorder(Context context, RecorderResult result) {
